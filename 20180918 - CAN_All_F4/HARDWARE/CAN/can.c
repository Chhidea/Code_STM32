...
{	
  ...
  u16 i=0;
  CanTxMsg TxMessage;
  TxMessage.StdId=0x7FF;	 // 标准ID（11位）
  TxMessage.ExtId=0x1FFFFFFF;	 // 设置扩展标示符（29位）
  TxMessage.IDE=0x00000004;		  // 使用标准标识符，标准为0x00000000，扩展为0x00000004
...
//	if((RxMessage.Data[0]|RxMessage.Data[1]==0XABCD)&&(RxMessage.StdId==0X0012)
//		&&(RxMessage.IDE==CAN_Id_Standard)&&(RxMessage.DLC==2))
//		{
//			canflag=0;//表示接收成功
//		}
//	else
